...
/** Part 6 — 教學版 3-stage RISC-V pipeline（Wildcat 精神，極簡）。 僅示範 fetch / decode+regread / execute+writeback 與 pipeline
  * register； 不含 forwarding / hazard / branch（見 Part 6 練習）。
  */
